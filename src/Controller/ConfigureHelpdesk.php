        ...
        switch (strtolower($request->request->get('specification'))) {
            ...
            case 'php-envfile-permission':
                    ...
                    if ($response['status']) {
                        ...
                        $response['description'] = '</span> Issue can be resolved by simply <a href="https://www.jacobn.com/en/blog/open-source-helpdesk-installation-on-ubuntu-jacobn/" target="_blank"><p> enabling your <b>.env</b> file read/write permission</a> refresh the browser and try again.</p>';
                    }
                break;
            case 'php-configfiles-permission':
                    ...
                    $response = [
                        ...
                        'description' => '</span> <br><p> Issue can be resolved by simply <a href="https://www.jacobn.com/en/blog/open-source-helpdesk-installation-on-ubuntu-jacobn/" target="_blank"> enabling read/write permissions for your files under config/packages folder of your project.</a></p>',
                    ];
                break;
            default:
                $code = 404;
