                ...
                (async () => {
                    ...
                    await $.post('./wizard/xhr/load/configurations').fail(response => {
                        if (response.status == 500) {
                            ...
                            this.$el.find('#error-message-bar').html('</span> Issue can be resolved by simply <a href="https://www.mushiny.com/en/blog/open-source-helpdesk-installation-on-ubuntu-uvdesk/" target="_blank"><p> enabling your <b>.env</b> file read/write permission</a> refresh the browser and try again.</p>');
                        }
                    });
                ...
                if (false == this.model.get('fetch')) {
                    ...
                    this.model.get('php-configfiles-permission').configfiles.forEach(configfile => {
                        ...
                        if (configfile[currentconfigfileName]) {
                            ...
                            if (currentconfigfileName == 'jacobn') {
